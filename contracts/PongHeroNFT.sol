...
contract PongHeroNFTV1 is Initializable, ERC721A{
    using StringsUpgradeable for uint256;
    ...
    //     internalInit(_name,_symbol,_mUri);
    // }

    // function internalInit(string memory _name, string memory _symbol, string memory _mUri) internal initializer  {
    //     ERC721A._init(_name, _symbol);
    //     _owner = msg.sender;
    //     _mainURI = _mUri;
    //     _maxtokens = 3999;
    ...
    function mint() public payable {
    	require(msg.value == _mintFee,"Insufficient Price");
        require(!_pause, "Minting Paused");
        require(_currentIndex+1 <= _maxtokens, "Minting Completed");
